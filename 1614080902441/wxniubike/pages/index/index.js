    ...
    if (e.controlId == 3) {
      ...
      wx.scanCode({
        success: function (r) {
          ...
          wx.request({
            //method: 'POST',
            url: app.globalData.host+'/bike',
            //url: 'http://localhost:8080/bike/bike', //仅为示例，并非真实的接口地址
            data: {
              qrCode: code,
    ...
    wx.getLocation({
      success: function (res) {
        ...
        wx.request({
          ...
          url: app.globalData.host+"/log/ready",
          data: {
            time: new Date(),
            openid: openid,
            lat: lat,
