...
Page({
  ...
  queryAnswer: function() {
      ...
      if (question == null || question==='') {
        ...
        page.setData({ question:'', content:datas, top:datas.length*100});
        ...
        wx.request({
          ...
          success: function(res){
            if(res.data.code==100000) {
                ...
                //console.log(datas);
                page.setData({ content: datas, top: datas.length * 100});
  ...
  loadContent: function() {
    ...
    wx.getStorage({
      ...
      success: function(res){
        //console.log(res);
        page.setData({content:res.data, top:res.data.length*100});
      }
    })
  },
})